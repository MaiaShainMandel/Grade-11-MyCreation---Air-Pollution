...
Maia Mandel
Ms. Krasteva
This program will create movingTruckss for
...
public class movingTrucks extends Thread
{
    private Console c;
    private Color Truck;
    private Color Door;
	...
	for (int x = 0 ; x < 641 ; x++)
	{
	    ...
	    c.setColor (Truck);
	    c.fillRoundRect (0 + x, 5, 175, 125, 10, 10); //movingTrucks body
	    c.setColor (Color.black);
	    c.drawRoundRect (0 + x, 5, 175, 125, 10, 10); //movingTrucks body outline
	    ...
	    c.setColor (Color.black);
	    c.drawLine (0 + x, 125, 50 + x, 125); //left bottom line body of movingTrucks
	    c.setColor (Color.black);
	    c.drawLine (120 + x, 125, 175 + x, 125); //right bottom line body of movingTrucks
	    c.setColor (Color.black);
	    c.drawArc (220 + x, 95, 65, 65, 0, 180); //right outline wheel
	    c.setColor (Color.black);
	    c.drawLine (185 + x, 125, 220 + x, 125); //left bottom line front of movingTrucks
	    c.setColor (Color.black);
	    c.drawLine (285 + x, 125, 295 + x, 125); //right bottom line front of movingTrucks
	    ...
	    c.setColor (Door);
	    int movingTrucksX[] = {245 + x, 245 + x, 270 + x, 295 + x};  //x axis for front of movingTrucks
	    int movingTrucksY[] = {80, 50, 75, 80};  //y axis for front of movingTrucks

	    c.fillPolygon (movingTrucksX, movingTrucksY, 4);
    ...
    //basic drawTruck
    public movingTrucks (Console con)
    {
	c = con;
    ...
    public movingTrucks (Console con, Color n, Color n1)
    {
	c = con;
	Truck = n;
	Door = n1;
    ...
    public movingTrucks (Console con, Color n, Color n1, int t)
    {
	c = con;
	Truck = n;
	Door = n1;
